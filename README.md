HighRest3DNet is now part of NiftNet, an open-source library for convolutional networks in medical image analysis. Please visit https://cmiclab.cs.ucl.ac.uk/CMIC/NiftyNet.
